<!--Test Oracle file for UBC CPSC304 2018 Winter Term 1
  ...
  <html>
    ...
    <body>
        ...
        <form method="POST" action="error-handling.php">
        ...
        <form method="POST" action="error-handling.php"> <!--refresh page when submitted-->
        ...
        <form method="GET" action="error-handling.php"> <!--refresh page when submitted-->
